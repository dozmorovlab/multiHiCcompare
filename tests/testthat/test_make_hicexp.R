test_that('make_hicexp works', {
  ...
  hicexp1 <- make_hicexp(r1, r2, r3, r4, r5, r6, r7, 
                         groups = groups, covariates = covariates)
