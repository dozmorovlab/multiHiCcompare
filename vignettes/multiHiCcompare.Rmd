...
hicexp1 <- cyclic_loess(hicexp1, verbose = FALSE, 
                        Plot = TRUE, parallel = FALSE, span = 0.2)
```
...
hicexp2 <- make_hicexp(HCT116_r1, HCT116_r2, HCT116_r3, 
                       HCT116_r4, groups = c(0, 0, 1, 1))
...
```{r, eval=FALSE}
# use Treat option
hicexp <- hic_glm(hicexp, design = d, coef = 2, method = "Treat", 
                  M = 0.5, p.method = "fdr", parallel = FALSE, Plot = FALSE)
```
