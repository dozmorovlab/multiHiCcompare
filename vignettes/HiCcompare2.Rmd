...
From here we can just import the matrix into R as you would normally for any tab-delimited file.
  ...
  4. Repeat these steps for any other Hi-C dataset that you wish to compare to the first dataset using  `HiCcompare2`, then proceed to [Creating the `hicexp` object](#hicexp).
...
<!-- need to add functionality to make_hicexp() for reading in BEDPE data -->
...
<!-- Probably should add something to just do library scaling normalization -->
